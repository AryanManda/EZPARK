    ...
    <form method="post" onSubmit={handleSubmit}>
      <label>
        ...
        <select name="locSelect">
          <option value="loc1">5000 Westhaven Ln.</option>
          <option value="loc2">5080 Chargrove Ave.</option>
          <option value="loc3">6000 Greenwich St.</option>
        </select>
      </label>
      <p>
      <label>
      ...
      <button type="submit">Pay and check-in</button>
    </form>
  );
}
...
//  A version where the website prompts back and forth like
//  the original UC desc. may be possible, but I cant figure it out atm
